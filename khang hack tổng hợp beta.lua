loadstring(game:HttpGet(("https://raw.githubusercontent.com/daucobonhi/Ui-Redz-V2/refs/heads/main/UiREDzV2.lua")))()
       ...
       local Window = MakeWindow({
         Hub = {
         Title = "khang Roblox tổng hợp",
         Animation = "khang hack"
         },
         Key = {
        KeySystem = true,
        Title = "bản premium nên có key nhé 1 tuần = 1key",
        Description = "",
        KeyLink = "https://link-hub.net/1433558/AeOgV6EfT6rm",
        Keys = {"minhhoalong6"},
        Notifi = {
        Notifications = true,
       ...
       MinimizeButton({
       Image = "http://www.roblox.com/asset/?id=138051097328009",
       Size = {60, 60},
...
------ Tab
     ...
     local Tab9o = MakeTab({Name = "tthe strongest battlegrounds"})
       local Tab10o = MakeTab({Name = "fish"})
------- BUTTON
  ...
  AddButton(Tab6o, {
     Name = "maru x khang hub",
    Callback = function()
	  loadstring(game:HttpGet("https://raw.githubusercontent.com/thunhchk/Maruvietsub/refs/heads/main/maruhubthinh.txt"))(https://raw.githubusercontent.com/bng882111-a11y/Maru/refs/heads/main/maru.txt)
  end
  })
