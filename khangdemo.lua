loadstring(game:HttpGet(("https://raw.githubusercontent.com/daucobonhi/Ui-Redz-V2/refs/heads/main/UiREDzV2.lua")))()
       ...
       local Window = MakeWindow({
         Hub = {
         Title = "khang tổng hợp",
         Animation = "discord: khang Roblox"
         },
        Key = {
        KeySystem = false,
        Title = "Key System",
       ...
       MinimizeButton({
       Image = "http://www.roblox.com/asset/?id=74454057005529",
       Size = {60, 60},
...
------ Tab
     ...
     local Tab9o = MakeTab({Name = "tthe strongest battlegrounds"})
       local Tab10o = MakeTab({Name = "fish"})ocal Tab1o = MakeTab({Name = "Script Farm"})
